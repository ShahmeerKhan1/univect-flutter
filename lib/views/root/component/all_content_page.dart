...
class AllContent extends StatelessWidget {
  AllContent({Key? key, this.index}) : super(key: key);
  ...
  Widget cotainerTile3(int index) {
    return Padding(
      ...
      child: Container(
        ...
        width: 15 * SizeConfig.widthMultiplier,
        decoration: BoxDecoration(
            color: index == 2 || index == 3 ? Colors.blue : Colors.white12,
            borderRadius: BorderRadius.circular(10)),
      ),
    );
  }

  Widget discoverDiviceWidget(BuildContext context) {
    return Container(
